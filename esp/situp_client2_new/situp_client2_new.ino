...
static BLEUUID charUUID("2122b241-dc8b-4673-af63-19ba55fc97ec");
...
void loop() {
  ...
  if (connected) {
    if (!isPushUpInProgress && roll > threshold) {
      ...
      // }
    } else if (isPushUpInProgress && roll < -threshold && millis() - lastPushUpTime > minDelay) {
